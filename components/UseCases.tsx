...
const UseCases: React.FC = () => {
  return (
    <section className="border-b border-brutal-line bg-white text-black font-inter">
      <div className="border-b border-black p-8 md:p-12">
        <h3 className="font-black text-4xl md:text-5xl uppercase">Mission</h3>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-black">
        <a
          href="#"
          className="p-12 h-64 flex flex-col justify-between hover:bg-brutal-accent transition-colors cursor-pointer"
          onClick={(e) => {
            e.preventDefault();
            // Will be replaced with actual links later
          }}
        >
          <h4 className="text-sm md:text-base font-bold uppercase">01 — Disaster Response</h4>
        ...
        >
          <h4 className="text-sm md:text-base font-bold uppercase">02 — Infra Inspection</h4>
          <p className="text-lg leading-tight max-w-sm">
        ...
        >
          <h4 className="text-sm md:text-base font-bold uppercase">03 — Precision Agriculture</h4>
          <p className="text-lg leading-tight max-w-sm">
