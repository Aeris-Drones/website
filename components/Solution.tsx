  ...
  return (
    <section className="border-b border-brutal-line bg-brutal-bg text-brutal-fg relative">
      <div className="grid grid-cols-1 lg:grid-cols-4">
        ...
        <div className="col-span-1 lg:col-span-1 p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-brutal-line flex flex-col justify-center sticky top-0 h-auto z-10 bg-brutal-bg">
          <div>
        ...
        <div className="col-span-1 lg:col-span-3 relative">
          {/* Feature 1 */}
          <div className="group border-b border-brutal-line h-[22vh] flex flex-col justify-center transition-colors cursor-crosshair hover:bg-white hover:text-black relative">
            <div className="p-8 lg:p-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10">
                <h3 className="font-sans font-black text-3xl md:text-5xl uppercase">
                    One Map.
                </h3>
          ...
          {/* Feature 4 */}
          <div className="group h-[22vh] flex flex-col justify-center transition-colors cursor-crosshair hover:bg-white hover:text-black relative">
            <div className="p-8 lg:p-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10">
                <h3 className="font-sans font-black text-3xl md:text-5xl uppercase">
                    Modular Pods.
                </h3>
